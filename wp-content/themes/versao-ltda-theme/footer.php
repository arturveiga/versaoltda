	...
	<div class="site-footer__inner container">
		<div class="footer-brand">
			...
			<img
				...
				src="<?php echo esc_url(vltda_asset('images/logo-bottom.png')); ?>"
		...
		<form class="newsletter" action="<?php echo esc_url(home_url('/')); ?>" method="post">
			...
			<p><?php esc_html_e('Fique perto da nossa lista e seja sempre o primeiro a saber sobre as futuras pre-orders.', 'versao-ltda-theme'); ?>
			</p>
